        ...
        <nav className="mt-6">
          <div>
            ...
            >
              ...
              <span className="mx-4 text-sm font-normal">Tenants</span>
            </NavLink>
            <NavLink
              className="flex items-center justify-start w-full p-4 my-2 font-thin text-gray-500 uppercase transition-colors duration-200 dark:text-gray-200 hover:text-blue-500"
              to="/buildings"
            >
              ...
              <span className="mx-4 text-sm font-normal">Buildings</span>
            </NavLink>
            <NavLink
              className="flex items-center justify-start w-full p-4 my-2 font-thin text-gray-500 uppercase transition-colors duration-200 dark:text-gray-200 hover:text-blue-500"
              to="/apartments"
            >
              ...
              <span className="mx-4 text-sm font-normal">Apartments</span>
            </NavLink>
            <NavLink
              className="flex items-center justify-start w-full p-4 my-2 font-thin text-gray-500 uppercase transition-colors duration-200 dark:text-gray-200 hover:text-blue-500"
              to="/payments"
            >
              ...
              <span className="mx-4 text-sm font-normal">Payments</span>
            </NavLink>
            <NavLink
              className="flex items-center justify-start w-full p-4 my-2 font-thin text-gray-500 uppercase transition-colors duration-200 dark:text-gray-200 hover:text-blue-500"
              to="/settings"
